...
test('Guardian RSS thumbnails are promoted to a bounded source-authentic HD transform', () => {
...
test('Guardian HD promotion never requests pixels wider than the identified master', () => {
...
test('already-HD and unrelated publisher media remain byte-for-byte unchanged', () => {
  const hd = 'https://i.guim.co.uk/img/media/example/0_0_2400_1600/master/2400.jpg?width=2000&quality=90&auto=format';
