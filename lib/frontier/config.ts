...
export const FRONTIER_LANES: FrontierLaneDefinition[] = [
  ...
  },
  {
    ...
    keywords: ['machine learning', 'data analysis', 'data science', 'statistics', 'causal', 'forecast', 'time series', 'visualization', 'feature engineering', 'polars', 'duckdb', 'pandas', 'benchmark', 'dataset'],
  },
  {
    id: 'ai_frontier', label: 'AI Frontier', shortLabel: 'AI', glyph: '◇',
    description: 'Foundation models, agents, reasoning, evaluation, safety, and interpretability.', weight: 1.14, realm: 'learn',
    keywords: ['foundation model', 'agent', 'reasoning', 'multimodal', 'mechanistic interpretability', 'alignment', 'inference', 'quantization', 'evaluation', 'language model', 'llm', 'transformer'],
  },
  {
    id: 'neuro_frontier', label: 'Neuroscience + NeuroAI', shortLabel: 'NeuroAI', glyph: '⌁',
    description: 'Neural representation, BCI, decoding, multimodal neuroscience, and brain data systems.', weight: 1.15, realm: 'learn',
    keywords: ['neuroscience', 'neural decoding', 'brain computer interface', 'bci', 'eeg', 'ecog', 'neuropixels', 'calcium imaging', 'neuroai', 'neural representation', 'brain imaging', 'fmri'],
  },
  {
    id: 'methods', label: 'Methods Worth Stealing', shortLabel: 'Methods', glyph: '∴',
    description: 'Algorithms and analytical ideas that can transfer into active projects.', weight: 1.1, realm: 'learn',
    keywords: ['ranking', 'retrieval', 'graph learning', 'contextual bandit', 'active learning', 'calibration', 'tracking', 'spatiotemporal', 'optimization', 'probability', 'information theory', 'representation learning'],
  },
  {
    id: 'builder_signal', label: 'Builder Signal', shortLabel: 'Open Source', glyph: '⌘',
    description: 'Open-source tools, research software, systems, infrastructure, and developer workflows.', weight: 1.08, realm: 'learn',
  ...
  },
  {
    ...
    description: 'High-information discoveries across biology, physics, cognition, medicine, and computer science.', weight: 0.99, realm: 'learn',
    keywords: ['biology', 'physics', 'cognition', 'scientific discovery', 'randomized trial', 'meta-analysis', 'replication', 'genomics', 'bioengineering', 'space', 'astronomy', 'medicine'],
  },
  {
    id: 'creative_tech', label: 'Project Design + Creative Tech', shortLabel: 'Project Design', glyph: '✺',
    description: 'WebXR, browser graphics, procedural worlds, game mechanics, interaction design, and prototypes worth remixing.', weight: 0.98, realm: 'learn',
    keywords: ['webxr', 'webgpu', 'shader', 'procedural', 'game design', 'browser graphics', 'spatial interaction', 'prototype', 'interaction design', 'creative coding', 'generative interface'],
  },
  {
    id: 'world_pulse', label: 'World + Tech Pulse', shortLabel: 'World Pulse', glyph: '◌',
    description: 'Consequential technology, platform, internet, business, policy, and culture shifts.', weight: 0.82, realm: 'learn',
  ...
  },
  {
    ...
    description: 'The sports you do and are learning, plus pro circuits, athlete stories, standout clips, NFL/NBA, fantasy, and worthwhile sports signal.', weight: 1.04, realm: 'play',
    keywords: ['rock climbing', 'sport climbing', 'bouldering', 'lead climbing', 'speed climbing', 'ifsc', 'mountain biking', 'mountain bike', 'mtb', 'downhill mtb', 'enduro mtb', 'crankworx', 'skiing', 'freeski', 'freeride', 'freeride world tour', 'skateboarding', 'skateboard', 'street skating', 'longboarding', 'longboard', 'ripstik', 'ripstick', 'caster board', 'ripsurf', 'ripsurfing', 'waveboard', 'nfl', 'nba', 'fantasy football', 'sports analytics', 'player tracking', 'expected value', 'highlight'],
  },
  {
  ...
  },
  {
    ...
    description: 'The funniest, strangest, most shareable posts, threads, memes, clips, and online culture worth your time.', weight: 0.88, realm: 'play',
...
export const FRONTIER_IMPORTANCE_TERMS = [
  ...
  'premier league', 'injury', 'transfer', 'trade', 'signing', 'release date', 'dlc', 'major update', 'world championship', 'final', 'record',
];
