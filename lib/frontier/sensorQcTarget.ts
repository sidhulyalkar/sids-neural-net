...
/**
 * Read-only mirror of FrontierReactionLoop's rendered-target scoring. Sensor QC
 * uses it only to measure how often the viewport is attributable; it never
 * writes a target, changes ranking, or feeds recommendation authority.
 */
export function measureSensorQcTargetFrame(): SensorQcTargetFrame {
