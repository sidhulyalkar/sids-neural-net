(() => {
  ...
  // Sap is a bridge between physical landings, never an alternate ladder. Every
  // Sap-heavy phrase below alternates an authored air anchor with a real branch.
  // There are no consecutive anchor-only floors in the production route set.
  const balanced = {
    GROVE: [
    ...
    SAPRUN: [
      ...
      { dy: 150, side: 'left', branch: false, anchor: 'left' },
      { dy: 116, side: 'right', length: 300, ring: 'lane' },
      { dy: 154, side: 'left', branch: false, anchor: 'right', ring: 'anchor' },
    ...
    SKYHOOK: [
      ...
      { dy: 116, side: 'right', length: 255, ring: 'lane' },
      { dy: 168, side: 'left', branch: false, anchor: 'left', ring: 'anchor' },
    ...
    CROWNWEAVE: [
      ...
      { dy: 174, side: 'swap', branch: false, anchor: 'cross' },
      { dy: 112, side: 'center', length: 238, ring: 'crown' },
    ],
    PENDULUM: [
      { dy: 78, side: 'center', length: 310, launch: true },
      { dy: 160, side: 'left', branch: false, anchor: 'right' },
      { dy: 118, side: 'right', length: 258, ring: 'lane' },
      { dy: 166, side: 'left', branch: false, anchor: 'left', ring: 'anchor' },
    ...
    THUNDERCROWN: [
      ...
      { dy: 180, side: 'swap', branch: false, anchor: 'cross' },
    ...
    MIGRATION: [
      ...
      { dy: 154, side: 'swap', branch: false, anchor: 'cross' },
    ...
    AURORARUN: [
      ...
      { dy: 170, side: 'left', branch: false, anchor: 'right' },
    ...
    ECHOFLIGHT: [
      ...
      { dy: 184, side: 'left', branch: false, anchor: 'right' },
    ...
    SKYHEART: [
      ...
      { dy: 190, side: 'swap', branch: false, anchor: 'cross' },
  ...
  S.sapRouteBalance = {
    version: VERSION,
    rule: 'every authored Sap anchor is followed by a physical landing opportunity before another Sap anchor',
