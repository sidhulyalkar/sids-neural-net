...
const categoryDefinitions: CategoryDefinition[] = [
  {
    ...
    summary: 'Background, research instincts, and the connective tissue behind the work.',
    leafLimit: 6,
  ...
  },
  {
    ...
    kind: 'category',
    morphology: 'pyramidal',
    annotation: 'build log',
    summary: 'Neural data infrastructure, applied AI systems, model tools, and creative builds.',
    leafLimit: 10,
  ...
  },
  {
    ...
    clusters: ['Life Outside the Lab', 'Personal Builds', 'Real-Time Creative Neurotech'],
  },
  {
    id: 'photography',
    label: 'Visual Cortex',
    ...
    summary: 'Photo cortex for landscape, texture, travel fragments, and visual attention outside the lab.',
    leafLimit: 5,
    keywords: ['photo', 'field', 'shasta', 'life', 'personal', 'creative'],
    clusters: ['Life Outside the Lab', 'Personal Builds'],
    fallbackLeaves: [
      {
        id: 'field-notes',
        label: 'Visual Cortex',
