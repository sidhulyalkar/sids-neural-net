...
> = {
  cyan: {
    branch: 'stroke-white/20 group-hover:stroke-cyan/50 group-focus-visible:stroke-cyan/50',
    twig: 'stroke-cyan/25 group-hover:stroke-cyan/65 group-focus-visible:stroke-cyan/65',
    node: 'fill-[#020306]/90 stroke-cyan/30 group-hover:fill-cyan/[0.08] group-hover:stroke-cyan/75 group-focus-visible:fill-cyan/[0.08] group-focus-visible:stroke-cyan/75',
    signal: 'fill-cyan/55 group-hover:fill-cyan group-focus-visible:fill-cyan',
    label: 'text-white/55 group-hover:text-cyan group-focus-visible:text-cyan',
    detail: 'text-white/25 group-hover:text-cyan/55 group-focus-visible:text-cyan/55',
  },
  violet: {
    branch: 'stroke-white/20 group-hover:stroke-violet/50 group-focus-visible:stroke-violet/50',
    twig: 'stroke-violet/25 group-hover:stroke-violet/65 group-focus-visible:stroke-violet/65',
    node: 'fill-[#020306]/90 stroke-violet/30 group-hover:fill-violet/[0.08] group-hover:stroke-violet/75 group-focus-visible:fill-violet/[0.08] group-focus-visible:stroke-violet/75',
    signal: 'fill-violet/55 group-hover:fill-violet group-focus-visible:fill-violet',
    label: 'text-white/55 group-hover:text-violet group-focus-visible:text-violet',
    detail: 'text-white/25 group-hover:text-violet/55 group-focus-visible:text-violet/55',
  },
};
