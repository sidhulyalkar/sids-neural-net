...
expect(has(chargeIntent14,"CHARGE_INTENT_VERSION='0.14.0'",'retargetTicks:8','v014ChargeCommittedVector','v014ChargeCandidateVector','v014ChargeCandidateTicks','state.heldMoves=heldSetForVector(committed)','state.heldMoves=realHeld'),'v0.14 charged dash intent ownership incomplete');
...
// Character presentation must share one authoritative root and one logical screen space.
...
// Readability is presentation-only. Larger bullets must not secretly enlarge collision geometry.
