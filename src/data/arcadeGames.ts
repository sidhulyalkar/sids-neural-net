...
export const arcadeGames: ArcadeGame[] = [
  ...
  },
  {
    ...
    description:
      'A one-way portal action-puzzle expedition across the 1,000-scene Nature Atlas. Sprid crosses immersive full-device living worlds whose horizons, weather, particles, foreground depth, wildlife pressure, and environmental reactions change with each biome. Solve ecological resonance circuits, collect Mossglint, fight or route around patterned encounters, fire a charged neon gate, survive extraction, defeat guardians, and carry permanent upgrades deeper into the Atlas.',
    version: 'v0.7.0',
    status: 'playable',
    sourceVisibility: 'public',
    ...
    aspectRatio: '960 / 640',
    nativeSize: { width: 960, height: 640 },
    tags: ['portal gun', 'action puzzle', '1000-scene atlas', 'immersive worlds', 'high-DPI canvas', 'adaptive rendering', 'bosses', 'procedural music', 'powerups', 'extraction'],
    controls: [
      ...
      { input: 'Fullscreen', action: 'Expand the living world across the device display' },
