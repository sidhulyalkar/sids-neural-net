...
export const arcadeGames: ArcadeGame[] = [
  ...
  },
  {
    ...
    subtitle: 'LAND HIGHER · BRIDGE WITH SAP · COMPLETE CONTRACTS · CLIMB.',
    description:
      'A kinetic sequoia climber built around an alternating movement rhythm: physical log floors are the route and sparse authored Sap nodes bridge selected dangerous gaps. v0.6.1 makes Sap fail closed against button-spam: Shift chooses the strict nearest eligible unused amber node at the instant of the press, a node can be used only once per run, and that Sap charge stays spent until Pip physically holds a new higher log. Sap-heavy route families now alternate real landing floors with isolated anchors instead of chaining orange nodes through open air. A connection preserves the swing and adds only a tightly bounded momentum nudge rather than acting as a vertical launch button. Golden Cone Tokens sit on real log lines, altitude milestones and three Canopy Contracts reward varied traversal, and the between-run Canopy Shop sells consumable Extra Life, Stride Seed, Resin Flask and Trail Map tools without permanently raising Pip’s base movement stats. The larger Living Canopy quest remains intact: discover five Heartseeds, wake the Living Crown at floor 250, master six Canopy Wonders, and ring the Skyheart at floor 360 before the endless Elder Canopy.',
    version: 'v0.6.1',
    status: 'playable',
    sourceVisibility: 'public',
    ...
    aspectRatio: '3 / 2',
    nativeSize: { width: 960, height: 640 },
    tags: ['vertical climber', 'canopy contracts', 'cone tokens', 'run shop', 'missions', 'living canopy', 'heartseeds', 'canopy wonders', 'skyheart', 'nearest-node sap', 'momentum', 'aerial combos', 'procedural routes', 'persistent discovery', 'canvas'],
    controls: [
