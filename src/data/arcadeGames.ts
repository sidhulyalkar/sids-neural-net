...
export const arcadeGames: ArcadeGame[] = [
  ...
  },
  {
    slug: 'mosslight',
    title: 'Mosslight',
    subtitle: 'ROOMS OF RENEWAL · NOTHING TO DEFEAT.',
    description:
      'A fluid top-down ecological action-puzzle game. Aim independently while moving, then chain rain, sunlight, seeds, wind, care, and gathering to heal ten biome rooms and reconnect the Earthheart.',
    version: 'v0.1.0',
    status: 'playable',
    sourceVisibility: 'public',
    repoUrl: 'https://github.com/sidhulyalkar/sids-neural-net',
    launchUrl: '/game-runtimes/mosslight/index.html',
    aspectRatio: '960 / 640',
    nativeSize: { width: 960, height: 640 },
    tags: ['ecology', 'action puzzle', 'twin-stick aim', 'procedural canvas'],
    controls: [
      { input: 'W A S D', action: 'Accelerate and drift' },
      { input: 'Mouse + LMB', action: 'Aim and cast restoration tools' },
      { input: '1 — 6 / Q E', action: 'Select or cycle abilities' },
      { input: 'Shift', action: 'Momentum dash' },
      { input: 'Arrow Keys + Space', action: 'Keyboard aim and cast fallback' },
