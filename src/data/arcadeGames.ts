...
export const arcadeGames: ArcadeGame[] = [
  ...
  },
  {
    slug: 'mosslight',
    title: 'Mosslight',
    subtitle: 'ATLAS EXPEDITIONS · RESTORE, DON’T DEFEAT.',
    description:
      'A replayable ecological action-puzzle game starring Sprig, a tiny moss keeper. Each expedition draws ten unseen environments from the site’s canonical 1,000-scene Nature Atlas, then remixes palette, atmosphere, geometry, wildlife, hazards, and visual motifs around a stable restoration learning curve.',
    version: 'v0.2.1',
    status: 'playable',
    sourceVisibility: 'public',
    ...
    aspectRatio: '960 / 640',
    nativeSize: { width: 960, height: 640 },
    tags: ['ecology', 'action puzzle', '1000-scene atlas', 'replayable', 'procedural canvas'],
    controls: [
      { input: 'W A S D', action: 'Move Sprig smoothly' },
      { input: 'Mouse / Arrow Keys', action: 'Aim with pointer or laptop-friendly keyboard controls' },
