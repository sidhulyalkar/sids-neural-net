...
export const arcadeGames: ArcadeGame[] = [
  ...
  },
  {
    ...
    controls: [
      ...
      { input: 'Release Shift', action: 'Release the tether and vault with preserved momentum + Air Kick refresh' },
