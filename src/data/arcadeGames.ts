...
export const arcadeGames: ArcadeGame[] = [
  ...
  },
  {
    slug: 'mosslight',
    title: 'Mosslight',
    subtitle: 'ATLAS EXPEDITIONS · RESTORE, ADAPT, SURVIVE.',
    description:
      'A replayable ecological action-puzzle game starring Sprig, a tiny moss keeper. Ten-world expeditions draw from the canonical 1,000-scene Nature Atlas, escalate from gentle restoration into moving wildlife and terrain puzzles, and let collectible world gifts evolve firing speed, projectile size, spread, piercing, mobility, and shielding into a different build each run.',
    version: 'v0.3.0',
    status: 'playable',
    sourceVisibility: 'public',
    ...
    aspectRatio: '960 / 640',
    nativeSize: { width: 960, height: 640 },
    tags: ['ecology', 'action puzzle', '1000-scene atlas', 'replayable', 'powerups', 'procedural encounters', 'canvas'],
    controls: [
      { input: 'W A S D', action: 'Move Sprig through changing terrain routes' },
      { input: 'Mouse / Arrow Keys', action: 'Aim with pointer or laptop-friendly twin-stick controls' },
      { input: 'Click / Space', action: 'Cast the selected restoration tool' },
      { input: 'Shift', action: 'Dash through timed hazard windows' },
      { input: 'Q / E', action: 'Cycle unlocked restoration tools' },
      { input: '1 — 6', action: 'Directly select a restoration tool' },
      { input: 'World gifts', action: 'Collect persistent firing, mobility, and shield upgrades' },
      { input: 'R / P', action: 'Restart world / pause' },
    ],
    accent: 'cyan',
  },
];
