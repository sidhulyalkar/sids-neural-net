...
export const arcadeGames: ArcadeGame[] = [
  ...
  },
  {
    ...
    description: 'A fast vertical action platformer about climbing a single ancient tree from Rootreach to the Heartwood Crown while mechanized felling crews dismantle it around you. Movement is the primary weapon. Arrow keys drive running and air steering, Space handles jumping and Bark Grip launches, W casts the elastic Sapline to authored Resin Knots, Shift spends one Canopy Step, and D draws a short machete only during attacks. The Sapline is simulated at the same deterministic 120 Hz as the rest of the game: it reels while held, applies spring tension and radial damping, accepts tangential steering, and preserves generated velocity on release rather than teleporting the character. Living limbs flex, deadwood collapses, vines conserve swing momentum, sap branches and downward enemy hits rebound the guardian and restore aerial mobility. The compact machete remains a counter tool for directional strikes and projectile redirects, but traversal speed, positioning and aerial routing are the core combat advantage. Five escalating tree regions introduce Fell Crew pressure, trunk climbers, ranged lanes, drones, cable traps, moving saws and the three-phase Crown Feller.',
    ...
    tags: ['action platformer', 'vertical ascent', 'dark forest', 'sapline', 'elastic tether', 'momentum platforming', 'tree traversal', 'branch physics', 'vine swinging', 'wall movement', 'aerial combat', 'projectile counter', 'boss combat', 'custom keybinds', '120 hz simulation'],
    controls: [
