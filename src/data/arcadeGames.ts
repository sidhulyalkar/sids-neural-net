...
export const arcadeGames: ArcadeGame[] = [
  ...
  },
  {
    ...
    subtitle: 'CLIMB · FLOW · REACH THE NEXT CROWN.',
    description:
      'A kinetic sequoia climber built around sparse routes, open Grove Chambers, branchless amber-anchor runs, and a visible Crown Trail that gives every run a next target. Crown Marks appear every 25 floors, your personal best height persists between runs, and the playfield HUD stays deliberately minimal so the forest remains the game. Running converts earned momentum into jump height, passive bark remains a low-energy redirect, and deliberate Bark Cling → Bark Kick is the wall skill. Sap Stick is a one-button movement tool: press Shift to fire immediately at the best reachable amber knot, hold Shift while using A/D or the arrow keys to shape the swing, then release Shift to vault with preserved momentum and a refreshed Air Kick. A short acquisition buffer forgives slightly early presses without making the grapple automatic. Ordinary Sap vaults now preserve Flow rather than printing combo links; a fast, deliberately shaped Clean Sap release earns the SAP link. Difficulty grows with altitude in several directions at once: later routes shorten safe branches, increase open-air anchor chains, add deterministic crosswind, and introduce WINDLINE, SKYHOOK, and CROWNWEAVE route families while the rising canopy pressure keeps the climb moving. ROOTWAYS stays readable, HIGH CANOPY becomes exposed and gusty, and CROWNLINE asks the player to combine momentum, Sap timing, Bark recovery, and route reading. The production art stack combines deterministic puzzle-fit sequoia bark, deep flake shadows, organic branch ecology, volumetric-looking light, atmospheric haze, cloud wisps and distant birds, and a mascot-style Pip while keeping collision geometry exact.',
    version: 'v0.4.0',
    status: 'playable',
    sourceVisibility: 'public',
    ...
    aspectRatio: '3 / 2',
    nativeSize: { width: 960, height: 640 },
    tags: ['vertical climber', 'crown trail', 'sap stick', 'branchless routes', 'procedural bark', 'altitude biomes', 'crosswind', 'aerial combos', 'double jump', 'bark cling', 'momentum', 'route grammar', 'telemetry', 'canvas'],
    controls: [
      ...
      { input: 'Crown Mark every 25 floors', action: 'Chase the next in-world Crown gate and push your persistent personal-best height' },
